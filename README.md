...
| **Model Answers** | Provides interview-ready model answers for generated questions |
...
> Test counts should be updated after running the final test suite on the submitted version.
...
1. **IBM watsonx.ai / Granite configuration**
2. **Project architecture / RAG workflow**
3. **Candidate profile and Interview Kit configuration**
4. **Generated Questions**
5. **Model Answers**
6. **Tips & Strategy**
7. **Answer Evaluation**
8. **Mock Interview / Final Feedback**
